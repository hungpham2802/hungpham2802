...
$patches = @{        
    "SharePoint Server Subscription Edition" = @(
        "https://download.microsoft.com/download/5/8/f/58fcfd0c-a364-4e96-a4f2-95c421279785/uber-subscription-kb5002603-fullfile-x64-glb.exe"
    )
	"SharePoint 2019" = @(
        "https://download.microsoft.com/download/e/3/2/e3231c65-cb45-4b8d-a2f6-064cec512702/sts2019-kb5002602-fullfile-x64-glb.exe"
    )
	"SharePoint 2016" = @(        
		"https://download.microsoft.com/download/5/9/d/59d2cfdb-abb1-4e0f-b072-7bba9b8e2952/sts2016-kb5002604-fullfile-x64-glb.exe"
    )
}
$spVersionNumber = ""
...
if ($farm.BuildVersion.Build -gt 14000) {
	...
	$spVersionNumber = "16.0.17328.20362-June2024"
