...
$patches = @{        
    "SharePoint Server Subscription Edition" = @(
        "https://download.microsoft.com/download/4/b/4/4b4d907f-2e25-4972-a7b1-dfe8d1c0fadb/uber-subscription-kb5002651-fullfile-x64-glb.exe"
    )
	"SharePoint 2019" = @(
        "https://download.microsoft.com/download/e/8/6/e86dadad-c8b4-4c32-831b-205e7254ce7a/sts2019-kb5002650-fullfile-x64-glb.exe"		
    )
	"SharePoint 2016" = @(        
		"https://download.microsoft.com/download/2/d/8/2d8102c2-e356-4ac7-b311-5a7de85abb28/sts2016-kb5002654-fullfile-x64-glb.exe"
    )
}
$spVersionNumber = ""
