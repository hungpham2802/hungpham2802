...
$patches = @{        
    "SharePoint Server Subscription Edition" = @(
        "https://download.microsoft.com/download/b/a/b/bab0c7cc-0454-474b-8538-7927f75e6486/uber-subscription-kb5002564-fullfile-x64-glb.exe"
    )
	"SharePoint 2019" = @(
        "https://download.microsoft.com/download/6/3/6/636ab15e-f81d-4de7-97fe-2af633e71e13/sts2019-kb5002562-fullfile-x64-glb.exe"
    )
	"SharePoint 2016" = @(        
		"https://download.microsoft.com/download/8/4/f/84f46492-98c7-4931-ae0f-4e8521bda1d0/sts2016-kb5002559-fullfile-x64-glb.exe"
    )
}
$spVersionNumber = ""
...
if ($farm.BuildVersion.Build -gt 14000) {
	...
	$spVersionNumber = "16.0.17328.20136-March2024"
