...
$patches = @{        
    "SharePoint Server Subscription Edition" = @(
        "https://download.microsoft.com/download/b/d/8/bd8f3278-11ae-4f3f-8d81-8188ca3457a6/uber-subscription-kb5002581-fullfile-x64-glb.exe"
    )
	"SharePoint 2019" = @(
        "https://download.microsoft.com/download/0/7/6/07692253-ef3f-4197-8409-bc4610a7d773/sts2019-kb5002580-fullfile-x64-glb.exe",
		"https://download.microsoft.com/download/7/e/8/7e8afdd8-5b84-4543-87c2-bdb89858516a/wssloc2019-kb5002538-fullfile-x64-glb.exe"
    )
	"SharePoint 2016" = @(        
		"https://download.microsoft.com/download/c/1/5/c151a063-a2f0-4752-be90-9e3f7ffda583/sts2016-kb5002583-fullfile-x64-glb.exe"
    )
}
$spVersionNumber = ""
